...
print " RIYONO10 login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""〘👑RIYONO10👑〙
╔══════════════════════  
...
administrator = ["u16d91c94c7cb6c53de85869706f60f96"]
admin = ["u16d91c94c7cb6c53de85869706f60f96"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks For Add Me By 􀰂􀰂􀰂􀰂@RIYONO10",
    "lang":"JP",
    "comment":"Auto Like By  􀰂􀰂􀰂􀰂@RIYONO10 􀂳􏿿",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u16d91c94c7cb6c53de85869706f60f96":
                    if "join:" in msg.text:
...
#-----------------------------------------------------------   
				...
				OWN = "u16d91c94c7cb6c53de85869706f60f96"
				if msg.from_ in OWN:
					pass
				else:
