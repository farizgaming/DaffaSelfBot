...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner. By: @1DaffaN3Kalani",
    "lang":"JP",
    "comment":"Owner. By: @1DaffaN3Kalani",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#.acceptGroupInvitationByTicket(msg.to,Ticket)
				...
				if msg.from_ in admin:
							...
							kc.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["Out","Bye Bye","Bye"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						ginfo = cl.getGroup(msg.to)
						try:
...
#-----------------------------------------------
				elif msg.text in ["Tagall","Woyy","Assalamualaikum"]:
					 if msg.from_ in admin:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					start = time.time()
					cl.sendText(msg.to, "Please Wait...95%...")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by @1DaffaN3Kalani")
						print "Like"
					except:
							pass
				else:
